...
class KanbanItemEdit extends React.Component {

  /** On successful submit, insert the data. */
  submit(data) {
    const { name, description, status, _id } = data;
    HobbyItems.collection.update(_id, { $set: { name, description, status } }, (error) => (error ?
...
export default withTracker(({ match }) => {
  ...
  return {
    doc: HobbyItems.collection.findOne(documentId),
