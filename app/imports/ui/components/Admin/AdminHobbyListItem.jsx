...
class AdminHobbyListItem extends React.Component {
  ...
  render() {
    return (
        <Table.Row>
          <Table.Cell>{this.props.hobbyItem.hobbyName}</Table.Cell>
          <Table.Cell>{this.props.hobbyItem.username}</Table.Cell>
